...
async def admin_dashboard(
    ...
    for law in service_laws:
        cases = await case_manager.get_cases_by_law(law, service)
...
async def view_case(
    ...
    law, result, rule_spec, parameters = await evaluate_law(case.bsn, case.law, case.service, machine_service)
