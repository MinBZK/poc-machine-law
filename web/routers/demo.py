...
async def workspace_features(request: Request) -> HTMLResponse:
    ...
    feature_path = "features/toeslagen/zorgtoeslagwet_TOESLAGEN-2025-01-01.feature"
...
async def list_features() -> RedirectResponse:
    ...
    return RedirectResponse(
        url="/demo/feature/features/toeslagen/zorgtoeslagwet_TOESLAGEN-2025-01-01.feature",
        status_code=302,
    )
