...
class FeatureFlags:
    ...
    DEFAULTS = {
        ...
        "VERTEGENWOORDIGING": False,  # Legal representation feature is disabled by default
    }
...
def is_vertegenwoordiging_enabled() -> bool:
    """Check if the legal representation feature is enabled."""
    return FeatureFlags.is_enabled("VERTEGENWOORDIGING")
