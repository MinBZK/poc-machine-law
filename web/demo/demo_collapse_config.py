...
DEMO_COLLAPSE_CONFIG = {
    ...
    "awb/bezwaar/JenV-2024-01-01": {
        "expand_paths": [
            ...
            "properties.applies.ZAAK.events",
            "properties.applies.ZAAK.update",
            "properties.sources",
            "properties.output",
            ...
            "actions.reden_niet_mogelijk",
            "actions.bezwaartermijn",
            "actions.beslistermijn",
            "actions.verdagingstermijn",
        ],
        "collapse_all_except_expanded": True,
    },
}
