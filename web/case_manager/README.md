...
from case_manager import CaseManagerInterface, MachineInterface
...
- `MachineInterface`: Interface for law evaluation functionality
...
```python
from case_manager.factory import CaseManagerFactory, MachineFactory, MachineType
