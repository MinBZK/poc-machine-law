...
class PythonMachineService(MachineInterface):
    """
    Implementation of MachineInterface using the embedded Python machine.service library.
    """
    ...
    async def set_profile_data(self, bsn: str) -> None:
        """
    ...
    async def extract_value_tree(self, root):
        return self.services.extract_value_tree(root)
