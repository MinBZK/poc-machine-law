...
T = TypeVar("T", bound="EvaluateResponse200")


@_attrs_define
class EvaluateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        evaluate_response_200 = cls(
            data=data,
        )

        evaluate_response_200.additional_properties = d
        return evaluate_response_200
