# python build stubs for package service
...
add_checked_function(mod, 'service_NewRuleService', retval('int64_t'), [param('char*', 'serviceName'), param('int64_t', 'services')])
add_checked_function(mod, 'service_NewServices', retval('int64_t'), [param('int64_t', 'referenceDate')])
add_checked_function(mod, 'service_NewCaseManager', retval('int64_t'), [param('int64_t', 'services')])

mod.generate(open('service.c', 'w'))
